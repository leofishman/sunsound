...
/**
 * Filters by given list of Institutions.
 *
 * @ingroup views_filter_handlers
 *
 * @ViewsFilter("futured_extras_institutions")
 */
class Institutions extends InOperator {
 ...
 /**
  ...
  public function init(ViewExecutable $view, DisplayPluginBase $display, array &$options = NULL) {
    ...
    $this->valueTitle = t('Institutions');
    $this->definition['options callback'] = array($this, 'generateInstitutionsOptions');
   ...
   * @return array
   */
  public function generateInstitutionsOptions() {

    $institutions = $this->entitiesQueryService->runCustomQuery(6);
